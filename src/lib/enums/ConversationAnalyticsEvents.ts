/**
 * Enumeration of events related to conversation analytics.
 *
 ...
 * - `Silence`: Event for periods of silence.
 * - `MetricsUpdate`: Event for real-time engagement metrics updates.
