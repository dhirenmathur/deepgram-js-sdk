...
export type ConversationRequestFile = ArrayBuffer | Buffer | Blob | any; // To match other audio APIs
...
export interface SpeakerAnalysis {
  ...
  key_phrases?: {phrase: string; count: number; timestamps: number[]}[];
}
...
export interface ConversationResults {
  ...
  transcription?: {
    ...
    by_speaker?: Record<string, {text: string; start_time: number; end_time: number}[]>;
  };
}
