...
export type ConversationRequestFile = Blob | ArrayBuffer | Buffer; // For binary audio

export interface ConversationAnalyzeParams {
  callback?: string;
...
export interface ConversationStreamParams extends Omit<ConversationAnalyzeParams, "callback" | "callback_method"> {}
